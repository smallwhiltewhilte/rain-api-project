...
//        Boolean check_video_time = this.check_video_time(video_path, mp4folder_path + mp4_name);
    ...
    public static void main(String[] args) throws IOException {
        //ffmpeg的路径
        String ffmpeg_path = "D:\\ProgramFiles\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "D:\\xc_edu\\詹姆斯.avi";
        //转换后mp4文件的名称
        String mp4_name = "詹姆斯.mp4";
        //转换后mp4文件的路径
        String mp4_path = "D:\\xc_edu\\詹姆斯.mp4";
        //创建工具类对象
